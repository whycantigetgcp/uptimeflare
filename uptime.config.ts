...
const workerConfig = {
  ...
  monitors: [
    ...
    },
    {
      ...
      method: 'GET',
      target: 'https://one-api-amxf.onrender.com/',
      tooltip: 'oneapi二开-render',
      statusPageLink: 'https://one-api-amxf.onrender.com/',
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'newapi-render',
      method: 'GET',
      target: 'https://new-api-8mkg.onrender.com/',
      tooltip: 'newapi-render',
      statusPageLink: 'https://new-api-8mkg.onrender.com/',
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'chatapi-render',
      method: 'GET',
      target: 'https://chat-api-6155.onrender.com/home',
      tooltip: 'chatapi-render',
      statusPageLink: 'https://chat-api-6155.onrender.com/home',
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      method: 'GET',
      target: 'https://chat-api-ckmx.onrender.com/home',
      tooltip: 'chatapi-render2',
      statusPageLink: 'https://chat-api-ckmx.onrender.com/home',
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'voapi-render',
      method: 'GET',
      target: 'https://voapi-latest-4hw2.onrender.com',
      tooltip: 'voapi-render',
      statusPageLink: 'https://voapi-latest-4hw2.onrender.com',
      expectedCodes: [200],
      timeout: 10000,
    },
    {
